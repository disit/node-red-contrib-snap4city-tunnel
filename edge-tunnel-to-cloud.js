...
module.exports = function (RED) {
    ...
    function EdgeTunnelToCloud(config) {
        ...
        if (!fs.existsSync('/data/refresh_token')) {
            ...
            logger.info(encodeURI(url + params));
                ...
                if (xmlHttp.readyState === 4) {
                    ...
                    if (xmlHttp.status === 200) {
                        ...
                        if (xmlHttp.responseText != "") {
                            ...
                            wstunHost = s4cUtility.settingUrl(RED,node, "wsTunnelUrl", "wss://www.snap4city.org", "/wstunnel", true);
            ...
            node.error("You cannot use this node inside the Cloud platform but only on your own device to connect from the platform to the RED node installed in the device.");
        }
