/* NODE-RED-CONTRIB-SNAP4CITY-TUNNEL
...
module.exports = function (RED) {
    ...
    function Snap4cityAuthenticationTunnel(config) {
    ...
    RED.httpAdmin.post("/retrieveAccessTokenAuthentication/", RED.auth.needsPermission('snap4city-authentication-tunnel.read'), function (req, res) {
        var s4cUtility = require("./snap4city-utility.js");
        res.json({
    ...
    RED.nodes.registerType("snap4city-authentication-tunnel", Snap4cityAuthenticationTunnel, {
        credentials: {
            user: {
                type: "text"
            },
